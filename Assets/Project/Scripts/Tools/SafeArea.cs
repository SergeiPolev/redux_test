...
namespace Tools
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        private void DebugSafeArea()
        {
            if (Application.platform == RuntimePlatform.Android)
            {
                try
                {
                    ...
                    var safe = new AndroidJavaClass("com.playgenes.safearea.SafeAreaHelper");
                    var androidSafe =
        ...
        private void ApplySafeArea(Rect r)
        {
            ...
            {
                Debug.LogFormat(
                    "New safe area applied to {0}: x={1}, y={2}, w={3}, h={4} on full extents w={5}, h={6}, nativeCutoutHeight={7}",
